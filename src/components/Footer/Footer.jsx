...
/* 
! Hacer uso del footer en donde se pueda
*/

export const Footer = () => {
return (
  
<footer className ="  shadow h-30  footer-container absolute w-screen px-24 self-end " >
    <div className ="flex tems-center justify-between">
        <img src="../img/logo-footer.png" alt="logo" className={`w-40 h-30`}/>
